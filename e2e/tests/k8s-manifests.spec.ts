...
describe('K8s Manifests - kubectl dry-run validation', () => {
  it('should pass kubectl dry-run for deployment.yaml', () => {
    ...
    // Act & Assert
    assert.doesNotThrow(() => {
      execCommand(`kubectl create --dry-run=client -f ${deploymentPath} -o yaml`);
  ...
  it('should pass kubectl dry-run for service.yaml', () => {
    ...
    // Act & Assert
    assert.doesNotThrow(() => {
      execCommand(`kubectl create --dry-run=client -f ${servicePath} -o yaml`);
  ...
  it('should pass kubectl dry-run for configmap.example.yaml', () => {
    ...
    // Act & Assert
    assert.doesNotThrow(() => {
      execCommand(`kubectl create --dry-run=client -f ${configmapPath} -o yaml`);
  ...
  it('should pass kubectl dry-run for secret.example.yaml', () => {
    ...
    // Act & Assert
    assert.doesNotThrow(() => {
      execCommand(`kubectl create --dry-run=client -f ${secretPath} -o yaml`);
  ...
  it('should validate all manifests can be applied together', () => {
    ...
    // Arrange & Act & Assert
    assert.doesNotThrow(() => {
      execCommand(`kubectl create --dry-run=client -f ${K8S_DIR}/ -o yaml`);
